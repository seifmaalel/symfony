 ...
 */
final class Version20211116143621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C8495510E9A39D FOREIGN KEY (idRz) REFERENCES reservation (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_ibfk_1 FOREIGN KEY (idRz) REFERENCES zone_de_loisir (id)');
