 ...
 */
final class Version20230227202452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE zone_de_loisir CHANGE nom nom VARCHAR(30) NOT NULL, CHANGE adresse adresse VARCHAR(30) NOT NULL, CHANGE tel tel VARCHAR(30) NOT NULL, CHANGE prix prix VARCHAR(30) NOT NULL, CHANGE type type VARCHAR(30) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hotel (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(25) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, adresse VARCHAR(25) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, tel INT NOT NULL, email VARCHAR(25) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, pageweb VARCHAR(25) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, prix INT NOT NULL, image VARCHAR(25) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = MyISAM COMMENT = \'\' ');
